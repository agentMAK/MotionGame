...
class Target:
    ...
    def getDimensions(self):
        ...
        #checking what the size/Dimensions is (size of their screen)

    def centerOrigin(self):
        return (self.x - self.width/2, self.y - self.height/2)
        #calculating the centerOrigin from dimenions given

    def update(self):
        self.x += self.speed[0]
        self.y += self.speed[1]
        #the ball is going down 1 in the y axis however staying at the same x axis
...
# Structuring element
#Create a circle and puts it on the screen at postiion (4,4)
